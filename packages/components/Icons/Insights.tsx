...
export const Insights: React.FC<Props> = ({ dur = 2.0, width = 25, fill = 'grey', alternateFill = 'grey', animated = false, className, onClick, disabled = false }) => (
  <IconContainer className={className} onClick={onClick} disabled={disabled} >
  <svg
    viewBox="0 0 24 24"
    width={width}
    fill={animated ? fill : alternateFill}
  >
    <path
